...
class NoteSequencer2(object):
    ...
    def __init__(self, sched, synth, channel, program, notes, loop=True, wait=0):
        ...
        """
        super(NoteSequencer2, self).__init__()
        self.sched = sched
        self.synth = synth
    ...
    def start(self):
        ...
        self.on_cmd = self.sched.post_at_tick(self._note_on, next_beat + self.wait)
